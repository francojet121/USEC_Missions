...
private ["_spawnPos", "_sideOrClass", "_heliClass", "_heli", "_dir", "_height", "_faction"];
...
if (typeName _sideOrClass != "SIDE") then {
    ...
    switch (_sideOrClass) do {
        case west: {
            _heliClass = [(["air", _sideOrClass, [(localize "str_Zen_Heli"), (localize "str_Zen_Gunship")], _faction] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
        case east: {
            _heliClass = [(["air", _sideOrClass, [(localize "str_Zen_Heli"), (localize "str_Zen_Gunship")], _faction] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
