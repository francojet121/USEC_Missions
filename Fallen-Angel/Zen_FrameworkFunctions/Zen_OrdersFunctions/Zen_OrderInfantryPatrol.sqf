...
if !([_this, [["VOID"], ["ARRAY", "OBJECT", "GROUP", "STRING"], ["ARRAY"], ["ARRAY", "SCALAR"], ["STRING"], ["STRING"], ["BOOL"], ["BOOL"]], [[], [], ["STRING", "SCALAR"], ["SCALAR"]], 2] call Zen_CheckArguments) exitWith {
...
if (count _this > 6) then {
    _chaseEnemy = _this select 6;
};

if (count _this > 7) then {
    _divers = _this select 7;
};
