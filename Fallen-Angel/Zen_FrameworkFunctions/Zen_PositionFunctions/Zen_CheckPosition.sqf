...
private ["_area", "_min", "_black", "_pos", "_failures", "_roadDist", "_minAngle", "_maxAngle", "_ID", "_objSwitch", "_objLimit", "_objDist", "_nearobj","_pointAvoidSwitch","_pointAvoidArray","_pointAvoidDist","_nearWaterSwitch","_nearWaterDist", "_roads", "_water", "_road", "_angleToPos", "_markerDir", "_markerSizeArray", "_markerCenterXY", "_markerShape", "_terrainSlopeSwitch", "_terrainSlopeAngle", "_terrainSlopeRadius", "_ambientClutterSwitch", "_ambientClutterCount", "_ambientClutterRadius", "_heightSwitch", "_heightNumber", "_heightRadius", "_maxFailures", "_height"];
...
_terrainSlopeRadius = _this select 19;
_ambientClutterSwitch = _this select 20;
_ambientClutterCount = _this select 21;
_ambientClutterRadius = _this select 22;
_heightSwitch = _this select 23;
_heightNumber = _this select 24;
_heightRadius = _this select 25;
_maxFailures = _this select 26;
_pos = _this select 27;
