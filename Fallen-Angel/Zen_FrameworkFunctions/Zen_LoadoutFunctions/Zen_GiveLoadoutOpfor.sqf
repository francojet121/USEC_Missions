...
#define STD_VEST ["V_HarnessO_brn", "V_HarnessOGL_brn", "V_HarnessOSpec_brn", "V_TacVest_brn", "V_TacVest_blk"]
#define STD_RUCK ["B_FieldPack_ocamo", "B_Carryall_ocamo", "B_FieldPack_khk", "B_Carryall_khk"]
#define STD_HEADGEAR ["H_HelmetO_ocamo", "H_HelmetLeaderO_ocamo", "H_HelmetSpecO_ocamo", "H_MilCap_ocamo", "H_Watchcap_blk", "H_Bandanna_gry"]
...
_Zen_stack_Trace = ["Zen_GiveLoadoutOpfor", _this] call Zen_StackAdd;
private ["_units", "_kit", "_giveGL", "_weapon", "_magazine", "_i", "_unit", "_kits", "_sendPacket"];
...

{
    ...
    {
        _unit linkItem _x;
    } forEach ["ItemGPS", "ItemWatch", "ItemRadio", "ItemMap", "ItemCompass", "NVGoggles_OPFOR"];
    ...
    switch (toLower ([_kit] call Zen_StringRemoveWhiteSpace)) do {
        case "recon": {
            ...
            _x addMagazines ["30Rnd_65x39_caseless_green", (7 + floor random 3)];
            ...
            _x addMagazineGlobal "O_IR_Grenade";

            _x addWeaponGlobal "Rangefinder";
            _x addWeaponGlobal "arifle_Katiba_F";
        ...
        case "rifleman": {
            ...
            _x addMagazines ["30Rnd_65x39_caseless_green", (11 + floor random 4)];
        ...
        case "grenadier": {
            ...
            _x addMagazines ["30Rnd_65x39_caseless_green", (10 + floor random 5)];
            ...
            _x addWeaponGlobal "arifle_Katiba_GL_F";
        ...
        case "autorifleman": {
            ...
            _x addMagazines ["HandGrenade", (2 + floor random 2)];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (1 + floor random 3)];
            _x addMagazines ["200Rnd_65x39_cased_Box", (3 + floor random 2)];
            ...
            _x addWeaponGlobal "LMG_Mk200_F";
        ...
        case "marksman": {
            ...
            _x addMagazines ["HandGrenade", (2 + floor random 2)];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["10Rnd_762x51_Mag", (9 + floor random 3)];
            ...
            _x addWeaponGlobal "srifle_DMR_01_F";
        ...
        case "teamleader": {
            ...
            _x addMagazines ["30Rnd_65x39_caseless_green", (10 + floor random 4)];

            if (_giveGL > 0.5) then {
                _x addMagazines ["1Rnd_HE_Grenade_shell", (10 + floor random 5)];
            } else {
                _x addMagazines ["30Rnd_65x39_caseless_green", (3 + floor random 2)];
            };
        ...
        case "squadleader": {
            ...
            _x addMagazines ["1Rnd_smokeblue_Grenade_shell", (5 + floor random 2)];
        ...
        case "atrifleman": {
            ...
            _x addMagazines ["HandGrenade", (2 + floor random 2)];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (1 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (9 + floor random 3)];
            _x addMagazines ["RPG32_F", 1];
            _x addMagazines ["RPG32_HE_F", 1];
            ...
            _x addWeaponGlobal "arifle_Katiba_F";
            _x addWeaponGlobal "launch_RPG32_F";
            _x addMagazines ["RPG32_F", 1];
        ...
        case "atspecialist": {
            ...
            _x addMagazines ["HandGrenade", (2 + floor random 2)];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (8 + floor random 5)];
            ...
            _x addWeaponGlobal "arifle_Katiba_F";
            _x addWeaponGlobal "launch_O_Titan_short_F";
        ...
        case "aaspecialist": {
            ...
            _x addMagazines ["HandGrenade", (2 + floor random 2)];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (7 + floor random 5)];
            ...
            _x addWeaponGlobal "arifle_Katiba_F";
            _x addWeaponGlobal "launch_O_Titan_F";
        ...
        case "assistantaa": {
            ...
            _x addMagazines ["HandGrenade", (2 + floor random 2)];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (8 + floor random 4)];
        ...
        case "assistantar": {
            ...
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (8 + floor random 4)];
            _x addMagazines ["200Rnd_65x39_cased_Box", (5 + floor random 2)];
        ...
        case "sapper": {
            ...
            _x addMagazines ["HandGrenade", (2 + floor random 2)];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (8 + floor random 3)];
        ...
        case "sniper": {
            _x addVest ([STD_VEST] call Zen_ArrayGetRandom);
            _x forceAddUniform "U_O_GhillieSuit";

            _x addMagazines ["6Rnd_45ACP_Cylinder", 3];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            ...
            _x addWeaponGlobal "hgun_Pistol_heavy_02_F";
        ...
        case "spotter": {
            ...
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (8 + floor random 2)];
        ...
        case "officer": {
            ...
            _x addMagazines ["6Rnd_45ACP_Cylinder", 2];
            _x addMagazines ["30Rnd_65x39_caseless_green", (5 + floor random 2)];
        ...
        case "helicopterpilot": {
            ...
            _x addMagazines ["30Rnd_9x21_Mag", (4 + floor random 2)];

            _x addHeadgear "H_PilotHelmetHeli_O";

            _x addMagazines [([CHEMLIGHT] call Zen_ArrayGetRandom), 2];
            (uniformContainer _x) addItemCargoGlobal ["FirstAidKit", 1];

            _x addWeaponGlobal "Binocular";
            _x addWeaponGlobal "SMG_02_F";
        ...
        case "helicoptercrew": {
            ...
            _x addMagazines ["HandGrenade", 1];
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), (2 + floor random 2)];
            _x addMagazines ["30Rnd_65x39_caseless_green", (7 + floor random 2)];

            _x addHeadgear "H_CrewHelmetHeli_O";
        ...
        case "fighterpilot": {
            ...
            _x addMagazines [([SMOKE] call Zen_ArrayGetRandom), 2];
            _x addMagazines ["6Rnd_45ACP_Cylinder", (3 + floor random 2)];
        ...
        case "diver": {
            _x forceAddUniform "U_O_Wetsuit";
        ...
        default {
            0 = ["Zen_GiveLoadoutOpfor", "Invalid loadout identifier given", _this] call Zen_PrintError;
            call Zen_StackPrint;
        };
    };
...
if (isMultiplayer && {_sendPacket}) then {
    Zen_MP_Closure_Packet = ["Zen_GiveLoadoutOpfor", _this];
