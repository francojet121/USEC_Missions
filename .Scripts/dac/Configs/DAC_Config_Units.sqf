...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ["O_crew_F","O_Helipilot_F","O_Soldier_SL_F","O_soldier_AR_F","O_soldier_AR_F","O_soldier_exp_F","O_soldier_GL_F","O_soldier_GL_F","O_soldier_M_F","O_medic_F","O_soldier_repair_F","O_Soldier_F","O_Soldier_F","O_soldier_LAT_F","O_soldier_lite_F","O_soldier_TL_F","O_soldier_TL_F"];
...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["I_crew_F","I_helipilot_F","I_officer_F","I_Soldier_LAT_F","I_Soldier_AA_F","I_Soldier_M_F","I_Soldier_GL_F","I_Soldier_exp_F","I_engineer_F","I_medic_F","I_Soldier_AR_F","I_Soldier_A_F"];
...
//-------------------------------------------------------------------------------------------------
  case 10:  // Knyte - ISAS (A3)
  {
    _Unit_Pool_S = ["O_MU_islam_R1_F","O_MU_islam_SL_F","O_MU_islam_SL_F","O_MU_islam_SL_F","O_MU_islam_TL_F","O_MU_islam_R1_F","O_MU_islam_R1_F","O_MU_islam_R2_F","O_MU_islam_R2_F","O_MU_islam_R3_F","O_MU_islam_R3_F","O_MU_islam_AR_F","O_MU_islam_GL_F","O_MU_islam_M_F","O_MU_islam_medic_F","O_MU_islam_AT_F"];
    _Unit_Pool_V = ["O_MU_islam_Offroad_01_F","O_MU_islam_Van_01_F"];
    _Unit_Pool_T = ["O_MU_islam_Offroad_01_armed_F"];
    _Unit_Pool_A = [];
  };
//-------------------------------------------------------------------------------------------------
  case 30:  // Knyte - Civilians (A3)
  {
    _Unit_Pool_S = ["C_man_1","C_man_1","C_man_1","C_man_polo_1_F","C_man_polo_2_F","C_man_polo_3_F","C_man_polo_4_F","C_man_polo_5_F","C_man_polo_6_F","C_man_1_1_F","C_man_1_2_F","C_man_1_3_F"];
    _Unit_Pool_V = ["C_Van_01_box_F","C_Van_01_transport_F","C_Offroad_01_F","C_Hatchback_01_sport_F","C_Hatchback_01_F"];
    _Unit_Pool_T = ["C_Van_01_box_F","C_Van_01_transport_F","C_Offroad_01_F","C_Hatchback_01_sport_F","C_Hatchback_01_F"];
...
//-------------------------------------------------------------------------------------------------
  case 31:  // Knyte - Civilians Desert (A3+RHS+____)
  {
    _Unit_Pool_S = ["C_man_polo_1_F_afro","C_man_polo_2_F_afro","C_man_polo_3_F_afro","C_man_polo_4_F_afro","C_man_polo_5_F_afro","C_man_polo_6_F_afro","C_man_p_fugitive_F_afro"];
    _Unit_Pool_V = ["rhs_uaz_vmf","rhs_uaz_open_vmf","C_Hatchback_01_F","C_Offroad_01_F","O_MU_islam_Offroad_01_F","I_MU_mercs_Offroad_01_F","MU_CIV_police_Offroad_01_F","C_SUV_01_F","C_Van_01_transport_F","C_Van_01_box_F"];
    _Unit_Pool_T = [];
    _Unit_Pool_A = [];
  };
//-------------------------------------------------------------------------------------------------
