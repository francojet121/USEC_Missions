...
VCOM_DRIVE_DEBUG = 0;
VCOM_fnc_VehicleDetection = compile preprocessFile "VCOM_Driving\Functions\VCOM_fnc_VehicleDetection.sqf";
VCOM_fnc_IsDriver = compile preprocessFile "VCOM_Driving\Functions\VCOM_fnc_IsDriver.sqf";
