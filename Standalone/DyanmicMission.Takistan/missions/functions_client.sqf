usec_mission_wreckSmoke = {
	...
	_PS2 setParticleParams [["\Ca\Data\ParticleEffects\Universal\Universal.p3d", 16, 8, 16], "", "Billboard", 1, 15, [0, 0, 0], [random 0.1, random 0.1,0.5 + random 0.5], 1, 1.275, 1, 0.066, [4, 5, 10, 10], [[0.1, 0.1, 0.1, 0.75], [0.4, 0.4, 0.4, 0.5], [1, 1, 1, 0.2]], [0], 1, 0, "", "", _obj]; //This P3D particle effect is depreciated with arma 2
