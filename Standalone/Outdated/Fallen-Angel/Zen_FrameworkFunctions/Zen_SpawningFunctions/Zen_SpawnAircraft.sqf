...
private ["_spawnPos", "_sideOrClass", "_aircraftClass", "_aircraft", "_dir", "_height", "_faction"];
...
if (typeName _sideOrClass != "SIDE") then {
    ...
    switch (_sideOrClass) do {
        case west: {
            _aircraftClass = [([["air", "autonomous"], _sideOrClass, [(localize "str_Zen_UAV"), (localize "str_Zen_Jet")], _faction] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
        case east: {
            _aircraftClass = [([["air", "autonomous"], _sideOrClass, [(localize "str_Zen_UAV"), (localize "str_Zen_Jet")], _faction] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
