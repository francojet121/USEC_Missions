...
private ["_spawnPos", "_sideOrClass", "_vehClass", "_veh", "_dir", "_faction"];
...
if (typeName _sideOrClass != "SIDE") then {
    ...
    switch (_sideOrClass) do {
        case west: {
            _vehClass = [([["car", "armored"], _sideOrClass, "All", _faction] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
        case east: {
            _vehClass = [([["car", "armored"], _sideOrClass, "All", _faction] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
